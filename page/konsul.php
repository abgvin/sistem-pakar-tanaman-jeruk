<div class="row">
    ...
    <h5>Pilh gejala yang terjadi pada tanaman jeruk anda !</h5>
    <br>
    <form action="" method="post">
        <table class="table table-bordered">
            ...
            <tbody>
                <tr>
                    <td>1</td>
                    <td>Daun berguguran</td>
                    <td>
                        <input type="radio" name="G1" value="0.35"> Ya <input type="radio" name="G1" value="0" checked> Tidak
                    </td>
                </tr>
                <tr>
                    <td>2</td>
                    <td>Pada daun atas tampak putih </td>
                    <td>
                        <input type="radio" name="G2" value="0.05"> Ya <input type="radio" name="G2" value="0" checked> Tidak                       
                    </td>                    
                </tr>
                <tr>
                    <td>3</td>
                    <td>Kulit batang mengering  </td>
                    <td>
                        <input type="radio" name="G3" value="0.35"> Ya <input type="radio" name="G3" value="0" checked> Tidak                       
                    </td>
                </tr>
                <tr>
                    <td>4</td>
                    <td>Pangkal batang luka coklat hitam </td>
                    <td>
                        <input type="radio" name="G4" value="0.15"> Ya <input type="radio" name="G4" value="0" checked> Tidak
                    </td>
                </tr>
                <tr>
                    <td>5</td>
                    <td>Keluar blendok </td>
                    <td>
                        <input type="radio" name="G5" value="0.2"> Ya <input type="radio" name="G5" value="0" checked> Tidak
                    </td>
                </tr>
                <tr>
                    <td>6</td>
                    <td>Permukaan daun terdapat lapisan berwarna hitam </td>
                    <td>
                        <input type="radio" name="G6" value="0.2"> Ya <input type="radio" name="G6" value="0" checked> Tidak
                    </td>
                </tr>
                <tr>
                    <td>7</td>
                    <td>Daun cepat layu dan gugur</td>
                    <td>
                        <input type="radio" name="G7" value="0.05"> Ya <input type="radio" name="G7" value="0" checked> Tidak
                    </td>
                </tr>
                <tr>
                    <td>8</td>
                    <td>Daun dikerumuni semut hitam </td>
                    <td>
                        <input type="radio" name="G8" value="0.35"> Ya <input type="radio" name="G8" value="0" checked> Tidak
                    </td>
                </tr>
                <tr>
                    <td>9</td>
                    <td>Jamur membentuk benang-benang mengkilat pada permukaan daun</td>
                    <td>
                        <input type="radio" name="G9" value="0.25"> Ya <input type="radio" name="G9" value="0" checked> Tidak
                    </td>
                </tr>
                <tr>
                    <td>10</td>
                    <td>Kulit buah membusuk</td>
                    <td>
                        <input type="radio" name="G10" value="0.65"> Ya <input type="radio" name="G10" value="0" checked> Tidak
                    </td>
                </tr>
                <tr>
                    <td>11</td>
                    <td>Pemucatan tulang daun berupa garis putus-putus memanjang</td>
                    <td>
                        <input type="radio" name="G11" value="0.25"> Ya <input type="radio" name="G11" value="0" checked> Tidak
                    </td>
                </tr>
                <tr>
                    <td>12</td>
                    <td>Sisi daun menggulung ke atas </td>
                    <td>
                        <input type="radio" name="G12" value="0.2"> Ya <input type="radio" name="G12" value="0" checked> Tidak
                    </td>
                </tr>
                <tr>
                    <td>13</td>
                    <td>Tunas tidak normal </td>
                    <td>
                        <input type="radio" name="G13" value="0.1"> Ya <input type="radio" name="G13" value="0" checked> Tidak
                    </td>
                </tr>
                <tr>
                    <td>14</td>
                    <td>Buah membusuk </td>
                    <td>
                        <input type="radio" name="G14" value="0.35"> Ya <input type="radio" name="G14" value="0" checked> Tidak
                    </td>
                </tr>
                <tr>
                    <td>15</td>
                    <td>Bintik warna coklat pada buah </td>
                    <td>
                        <input type="radio" name="G15" value="0.4"> Ya <input type="radio" name="G15" value="0" checked> Tidak
                    </td>
                </tr>
                <tr>
                    <td>16</td>
                    <td>Daun timbul warna coklat </td>
                    <td>
                        <input type="radio" name="G16" value="0.4"> Ya <input type="radio" name="G16" value="0" checked> Tidak
                    </td>
                </tr>
                <tr>
                    <td>17</td>
                    <td>Buah menggelembung</td>
                    <td>
                        <input type="radio" name="G17" value="0.2"> Ya <input type="radio" name="G17" value="0" checked> Tidak
                    </td>
                </tr>
                <tr>
                    <td>18</td>
                    <td>Rasa buah sangat masam </td>
                    <td>
                        <input type="radio" name="G18" value="0.25"> Ya <input type="radio" name="G18" value="0" checked> Tidak
                    </td>
                </tr>
                <tr>
                    <td>19</td>
                    <td>Pertumbuhan daun tidak teratur </td>
                    <td>
                        <input type="radio" name="G19" value="0.3"> Ya <input type="radio" name="G19" value="0" checked> Tidak
                    </td>
                </tr>
                <tr>
                    <td>20</td>
                    <td>Buah mempunyai ukuran kecil </td>
                    <td>
                        <input type="radio" name="G20" value="0.1"> Ya <input type="radio" name="G20" value="0" checked> Tidak
                    </td>
                </tr>
        ...
        <input type="submit" name="konsul" value="Submit" class="btn btn-info">
...
if ( isset($_POST['konsul']) ) {
    ...
    if ( $jm >= 0.35 ) {
        ...
        $username = $_SESSION['user'];
        $query = mysqli_query($con, "INSERT INTO nama_gejala (id, username, j1, j2, j3, j4, j5, j6, j7, j8, j9, j10, j11, j12, j13, j14, j15, j16, j17, j18, j19, j20, nama_penyakit, pengendalian) VALUES ('', '$username', '$j1', '$j2', '$j3', '$j4', '$j5', '$j6', '$j7', '$j8', '$j9', '$j10', '$j11', '$j12', '$j13', '$j14', '$j15', '$j16', '$j17', '$j18', '$j19', '$j20', '$penyakit', '$pengendalian')") or die(mysqli_error($con));
    } else if ( $jm < 0.35 ) {
        echo "
        <script>
